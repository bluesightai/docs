---
title: Introduction
description: 'Bluesight is an AI platform for geospatial data. We offer hosted inference of <a target="_blank" href="https://github.com/Clay-foundation/model">Clay foundation model</a> and a fine-tuning API for downstream tasks. All endpoints and support on the platform are free and will stay so through mid August. Please do get in touch at hello@bluesight.ai if you have questions or suggestions.'
---
...
<CardGroup cols={2}>
  <Card
    ...
    icon="satellite"
    href="/api-reference/embeddings/get-embeddings-with-images"
  >
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="tags"
    href="/api-reference/train/train-classification-model"
  >
